			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<form:form action="${contextPath}/university/update"
								method="post" modelAttribute="university">
								<div class="row">
									<div class="col-sm-2">
										...
										<div class="form-group">
											<div class="form-line">
												<form:input path="universityID" class="form-control"
													placeholder="" tabindex="1" readonly="true"
...
<div class="form-group">
   ...
   document.addEventListener("DOMContentLoaded", function() {
       ...
       const firstInputField = document.querySelector("input[name='universityName']");
